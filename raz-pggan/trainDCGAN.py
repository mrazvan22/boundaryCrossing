...
#dataroot = "celeba/"
train_images_list = 'celeba/celeba.csv'
...
dataset = DataLoaderOptimised.PngDataset(train_images_list, transformPIL)

#dataset = dset.ImageFolder(root=dataroot, transform=transformPIL
#                           )
...
for epoch in range(num_epochs):
  ...
  plt.legend()
  #plt.show()
  fig.savefig('generated/DCGAN-e%d-trainingLoss.png' % epoch)
  plt.close()
  ...
  ani.save('generated/DCGAN-e%d-animation.gif' % epoch, writer='imagemagick', fps=1)
  plt.close()
  HTML(ani.to_jshtml())
  ...
  #plt.show()
  fig.savefig('generated/DCGAN-e%d-fake.png' % epoch)
