...
from gan_pretrained_pytorch.mnist_dcgan.dcgan import Discriminator, Generator
...
nrImg = 10
latent_prog = torch.tensor(np.zeros((nrImg, latent_size, 1, 1), np.double), dtype=torch.float)
# import pdb
# pdb.set_trace()
